...
fissions_number = st.sidebar.number_input("Or enter number of fissions", min_value=1.0e+13, max_value=1.0e+20, value=fissions_number, step=None, format="%.1e", key="fission_input")


# Synchronisation des valeurs
if st.session_state.fission_slider != st.session_state.fission_input:
    st.session_state.fission_slider = fissions_number
    st.session_state.fission_input = fissions_number
