...
fission_value = float(selected_value)

# # Method 3
# fissions = st.sidebar.number_input("Select the number of fissions:", format="%.1e", value=1e17)


fissions_value = st.sidebar.number_input("Or enter number of fissions", min_value=1.0e+13, max_value=1.0e+20, value=fissions_value, step=None, format="%.1e", key="fission_input")
