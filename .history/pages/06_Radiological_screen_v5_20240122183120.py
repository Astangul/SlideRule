...
with tab2:
    ...
    fig1.update_layout(
        ...
        legend_title="You can click on legends below:",
        legend=dict(
    ...
    fig1.update_xaxes(type='lin', showgrid=True, title="Distance (m) [Log]")
    fig1.update_yaxes(type='lin', showgrid=True, title="Dose (Gy)[Log]", tickformat='.2e' )
    ...
    # Je veux que l'ordinne affiche toutes les décades.
    # Je veux que l'on puisse choisir log ou non
