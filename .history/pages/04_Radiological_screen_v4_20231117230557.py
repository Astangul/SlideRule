...
with st.expander("Expander"):
    with st.tabs(["Reference Case", "Data", "Graph"]):
        tabs = st.tabs(["Reference Case", "Data", "Graph"])
    
    if tabs == "Reference Case":
        # Contenu pour l'onglet "Reference Case"
        st.write("Content of Reference Case")
    
    elif tabs == "Data":
        # Contenu pour l'onglet "Data"
        st.write("Content of Data")
    
    elif tabs == "Graph":
        # Contenu pour l'onglet "Graph"
        st.write("Content of Graph")
