...
with st.expander("1/ Select Reference Case"):
    ...
    with tab1:
        ...
        SR_reference_df, SR_reference_filters = df_multiselect_filters(df_SR_original, default_columns=['Fissile', 'Case', 'Code', 'Particle', 'Screen', 'Thickness (cm)'], key="page1_key1")
...
toto_df, SR_test_filters = df_selectbox_filters(df_SR_original, default_columns=['Fissile', 'Case', 'Code', 'Particle', 'Screen', 'Thickness (cm)'], key="page1_key2")
