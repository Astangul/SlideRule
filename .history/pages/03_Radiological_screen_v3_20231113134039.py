...
def scatter_chart(x_data, y_data, err_y):
    ...
    fig.update_xaxes(minor = dict(ticks="inside", ticklen=6, griddash='dot', gridcolor='white', showgrid=True))
    #fig.update_xaxes(minor=dict(ticks="inside", tickmode='auto', ticklen=6, showgrid=True, griddash='dot', gridcolor='white'))
