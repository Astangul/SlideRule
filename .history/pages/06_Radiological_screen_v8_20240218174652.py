...
with tab1:
    ...
    st.write(f"Estimated prompt dose based on total fissions:",fissions)
    fig1 = go.Figure()
    ...
    fig1.update_yaxes(minor = dict(ticks="inside", ticklen=6, griddash='dot', nticks=10, showgrid=True))
