...
# Synchronisation des valeurs après la création des widgets
if f"{fissions_number_input:.1e}" != st.session_state.fission_slider:
    st.session_state.fission_slider = f"{fissions_number_input:.1e}"
