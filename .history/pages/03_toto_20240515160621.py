...
fission_value = st.sidebar.number_input("Enter number of fissions", min_value=1.0e+13, max_value=1.0e+20, value=fissions, step=None, format="%.1e", key="fission_input")
