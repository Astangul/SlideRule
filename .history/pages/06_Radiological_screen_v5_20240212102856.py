...
fissions = st.slider("Nombre de fissions", min_value=1e16, max_value=1e20, value=1e17, step=1e16, format='%e')
...
# slider_value = st.slider("Nombre de fissions (x1E15):", min_value=1, max_value=2000, value=1100, step=1)
...
# # Utilisez `fissions` pour vos calculs
# dose_multiplier = fissions / 1e17
