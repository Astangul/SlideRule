...
from utils.st_filter_dataframe import df_multiselect_filters_v3
...
with st.expander("1/ Select Reference Case"):
    ...
    with tab1:
        ...
        SR_reference_df, SR_reference_filters = df_multiselect_filters_v3(df_SR_original, default_columns=['Fissile', 'Case', 'Code'], key="page1_unique_key")
...
toto_df, SR_test_filters = df_multiselect_filters(df_SR_original)
