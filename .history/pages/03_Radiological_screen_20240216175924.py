...
def df_multiselect_filters(df: pd.DataFrame) -> (pd.DataFrame, dict):
    # """
    # Adds a UI on top of a dataframe to let viewers filter columns
...
with st.expander("1/ Select Reference Case"):
    ...
    with tab1:
        ...
        SR_reference_df, SR_reference_filters = dataframe_multiselect_filters(df_SR_original)
