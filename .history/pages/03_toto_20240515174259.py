...
def create_dose_plot(ref_data, ref_label, compare_data, colors, fissions_number_input):
...
with tab1:
    create_dose_plot(ref_data, ref_label, compare_data, colors, fissions_number_input)
