...
def tototutu(df: pd.DataFrame) -> (pd.DataFrame, dict):
...
# Utilisation de la fonction pour filtrer le DataFrame
from ma_fonction_de_filtrage import filter_dataframe_selectbox

filtered_df, filters_selected = filter_dataframe_selectbox(df)
...
df_test = tototutu(df_SR_original)
