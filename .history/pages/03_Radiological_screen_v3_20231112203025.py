...
def scatter_chart(sca_x, sca_y, err_y):
    ...
    tick_vals = list(np.logspace(0, 3, 11))
    fig.update_xaxes(type="log", tickvals=tick_vals, tickmode='array'showgrid=True)
...
sigma = df_SR_filtered['1s uncertainty']



scatter_chart(distance, dose, sigma)
