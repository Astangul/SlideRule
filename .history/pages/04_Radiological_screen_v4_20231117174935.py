...
def filter_dataframe_test(df: pd.DataFrame) -> pd.DataFrame:
    ...
    with filtered_data_container:
        ...
        st.write(df)  # Display filtered dataframe in a separate tab
