...
#  Method 1 : # Add a slider for the number of fissions
# Slider in scientific notation for the number of fissions
...
with tab1:
    ...
    log_x = st.checkbox("Logarithmic scale for the X axis", value=True)
