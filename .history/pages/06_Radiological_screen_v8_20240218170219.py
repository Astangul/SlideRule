...
with tab2:
    ...
    fig2.update_layout(
        hovermode='x', height=700, showlegend=True, legend_title="Click on legends below to hide/show:", xaxis={'showgrid': True, 'title': "Distance (m) [Log10]"}, yaxis={'showgrid': True, 'title': "Dose Ratio"})
