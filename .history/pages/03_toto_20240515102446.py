...
# compare_data = pd.DataFrame()  # Remplacez par vos données
# ref_data = pd.DataFrame()      # Remplacez par vos données
# generate_dose_ratio_plot(compare_data, ref_data, colors, tab2)




with tab2:
    generate_dose_ratio_plot(compare_data, ref_data, colors)
