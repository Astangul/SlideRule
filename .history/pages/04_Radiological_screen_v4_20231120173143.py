...
# 1/ REFERENCE CASE
with st.expander("1/ Choose Reference Case"):
...
# st.write("DataFrame filtré (v1) :", SR_filtered_df) # 
# st.dataframe(filtered_SR_df)

SR_filtered_df = df_SR_original  # Initialise le DataFrame filtré avec le DataFrame d'origine
