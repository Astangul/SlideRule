    ...
    for name, local_group in grouped_data:
        ...
        for i, code1 in enumerate(codes):
            for code2 in codes[i + 1:]:
                ...
                uncertainty_code1 = local_group[local_group['Code'] == code1]['1s uncertainty'].iloc[0] # il faut prendre l'incertitude absolue
                dose_code2 = local_group[local_group['Code'] == code2]['Dose (Gy)'].iloc[0]
                uncertainty_code2 = local_group[local_group['Code'] == code2]['1s uncertainty'].iloc[0]
