...
boiling_status = st.sidebar.radio(
    "Boiling ?",
    ("Yes", "No")
)
# ______________________________________________________________________________________________________________________
    ...
    case "Solution":
        ...
        match boiling_status:
            case "Yes":
                ...
                with col1:
                    V_sol = st.number_input("V", value=1.0, help="Total volume of the solution (in liters).")
                with col2:
                    d_sol = st.number_input("d_*sol*", value=1.0, help="Density of the solution (no unit) .")
                with col3:
                    V_crit_geo = st.number_input("V_crit_geom", value=0.5, min_value=0.0, max_value=V_sol, help="Minimum critical volume of solution for the considered geometry (in liters). See https://licorne.irsn.fr/")
            ...
            case "No":
                ...
                with col1:
                    V_sol = st.number_input("V", value=1.0, key="V_input", help="Total volume of the solution (in liters).")
                with col2:
                    d_sol = st.number_input("d_*sol*", value=1.0, help="Density of the solution (no unit).")
                with col3:
                    h = st.number_input("h", value=10.0, help="Convection heat transfer coefficient (in W/m²/°C).")
                with col4:
                    S_placeholder = st.empty()  # Utilisé pour remplacer plus tard la valeur
                with col5:
                    t = st.number_input("t", value=1.0, help="Duration of the criticality accident (in seconds).")
                ...
                with st.expander("Recommanded values for h and S (click to expand/collapse)"):
                    ...
                    with col2:
                        ...
                        with col_input2:
                            V_value2 = st.number_input("V", value=V_sol, key="V_input_copy", disabled=True, help="Total volume of the solution (in liters).")
                        ...
                        with col_input3:
                            st.number_input("S (calculated)", value=S_calculated, disabled=True, help="Heat transfer surface area (in m²).")
    ...
    case "Dry or low-moderated powder":
        ...
        match boiling_status:
            case "Yes":
                ...
                col1, col2, col3 = st.columns(3)
                with col2:
                    m_water = st.number_input("m_*water*", value=1.0, help="Total mass of water (in kg).")
                with col1:
                    m_powder = st.number_input("m_*powder*", value=1.0, help="Total mass of UO2 powder (in kg).")
                with col3:
                    m_water_crit_geo = st.number_input("m_*water_crit_geom*", value=0.5, min_value=0.0, max_value=m_water, help="Minimum critical mass of water for the considered geometry (in kg). See https://licorne.irsn.fr/")
            ...
            case "No":
                ...
                col1, col2 = st.columns(2)
                with col1:
                    m_water = st.number_input("m_*water*", value=1.0, key="m_water_no_boiling", help="Total mass of water (in kg).")
                with col2:
                    m_powder = st.number_input("m_*powder*", value=1.0, key="m_powder_no_boiling", help="Total mass of powder (in kg).")
        ...
        match boiling_status:
            case "Yes":
                ...
                with col3:
                    m_water = st.number_input("m_*water*", value=1.0, help="Total mass of water (in kg).")
                with col1:
                    m_pellet = st.number_input("m_*pellet*", value=1.0, help="Total mass of UO2 pellet (in kg).")
                with col2:
                    m_cladding = st.number_input("m_*cladding*", value=1.0, help="Total mass of Zircaloy cladding (in kg).")
                with col4:
                    m_water_crit_geo = st.number_input("m_*water_crit_geom*", value=0.5, min_value=0.0, max_value=m_water, help="Minimum critical mass of water for the considered geometry (in kg). See https://licorne.irsn.fr/")
                if m_water_crit_geo >= m_water:
                    # Message d'erreur si la condition n'est pas respectée
            ...
            case "No":
                ...
                with col3:
                    m_water = st.number_input("m_*water*", value=1.0, key="m_water_no_boiling", help="Total mass of water (in kg).")
                with col1:
                    m_pellet = st.number_input("m_*pellet*", value=1.0, key="m_pellet_no_boiling", help="Total mass of pellet (in kg).")
                with col2:
                    m_cladding = st.number_input("m_*cladding*", value=1.0, key="m_cladding_no_boiling", help="Total mass of cladding (in kg).")
    ...
    case "Dry solid metal":
        ...
        match boiling_status:
            ...
            case "No":
                ...
                with col2:
                    m_metal = st.number_input("m_*metal*", value=1.0, help="Total mass of metal (in kg)")
